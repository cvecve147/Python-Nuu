...
public class EasyAES {
    ...
    public static String encryptString(String content) {
        ...
        EasyAES ea = new EasyAES("1234567891234567", 128, "0000000000000000");
    ...
    public static String sixteen(String a){
        DecimalFormat df = new DecimalFormat("0000 0000 0000 0000 0000 0000 0000 0000");
        String ans = df.format(Integer.parseInt(a));
        return ans;
    }
}